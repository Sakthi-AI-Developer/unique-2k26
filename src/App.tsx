...
function Scene() {
  ...
  useEffect(() => {
      ...
      mount.innerHTML = `
        <div class="scene-fallback">
          <img
            ...
            alt="Dhanalakshmi Srinivasan Engineering College emblem"
          />
          <small>WEBGL SIGNAL UNAVAILABLE</small>
        </div>
      `
      return
    }
    ...
    let logoTexture: THREE.Texture =
      new THREE.TextureLoader().load('/college-emblem.svg')
    ...
    const emblemBody = new THREE.Mesh(
      new THREE.CylinderGeometry(1.72, 1.72, 0.25, 96),
      navy
    )
    ...
    const emblemBevel = new THREE.Mesh(
      new THREE.TorusGeometry(1.72, 0.105, 16, 96),
      gold
    )
    ...
    const emblemFaceMaterial = new THREE.MeshBasicMaterial({
      map: logoTexture,
      side: THREE.DoubleSide,
    })

    const emblemFace = new THREE.Mesh(
    ...
    const ribbonGradient = ribbonContext.createLinearGradient(
      0,
      0,
      0,
      220
    ...
    const ribbon = new THREE.Mesh(
      new THREE.BoxGeometry(2.8, 0.62, 0.16),
    ...
    const ribbonEdge = new THREE.Mesh(
      new THREE.BoxGeometry(3.02, 0.72, 0.09),
      gold
    )
    ...
    const pedestalBase = new THREE.Mesh(
      new THREE.CylinderGeometry(1.9, 2.05, 0.22, 96),
      navy
    )
    ...
    const pedestalTop = new THREE.Mesh(
      new THREE.CylinderGeometry(1.55, 1.7, 0.12, 96),
      new THREE.MeshStandardMaterial({
        color: 0xf0b42d,
        roughness: 0.19,
        metalness: 0.9,
    ...
    const glowRing = new THREE.Mesh(
      new THREE.TorusGeometry(1.72, 0.025, 8, 96),
    ...
    const rings = [
      ...
      [2.42, -0.16, 1.1],
      [1.95, 0.55, 2.0],
    ].map(([radius, tilt, speed], index) => {
      const ring = new THREE.Mesh(
        new THREE.TorusGeometry(radius, 0.018, 8, 96),
        new THREE.MeshBasicMaterial({
          color: index === 1 ? 0xe8ae31 : 0x2e83dc,
          transparent: true,
          opacity: 0.62,
        })
      )
  ...
  return (
    <div
      ref={mountRef}
      className="scene"
      aria-label="Interactive 3D Dhanalakshmi Srinivasan Engineering College emblem"
      role="img"
    />
  )
}
...
function GlassCoordinatorVisual({
  ...
  useEffect(() => {
    ...
    const animate = (
      ...
      shape.style.transform = `
        translate3d(
          ${floatX + currentX * 5}px,
          ${floatY + currentY * 5}px,
          18px
        )
        rotateX(${currentY * 5}deg)
        rotateY(${rotation + currentX * 7}deg)
        rotateZ(${rotation * 0.45}deg)
      `
  ...
  return (
    <div
      ref={containerRef}
      className="glass-coordinator-visual"
      style={{
        perspective: '1200px',
      }}
    >
        ...
        <main>
          ...
          >
            ...
            <div className="hero-visual">
              ...
              <div className="orbit-label orbit-left">
                02 / CREATIVITY
              </div>

              <div className="orbit-label orbit-right">
                03 / COLLABORATION
              </div>
          ...
          >
            ...
            >
              ...
              <p>
                Ten ways to make the
                weekend yours. Select
                one Technical and one
                Non-Technical event per
                team.
              </p>
            </motion.div>
            ...
            <div className="participation-rule">
              ...
              <small>
                ONE TEAM CAN SELECT ONE
                TECHNICAL + ONE NON-TECHNICAL
                EVENT.
              </small>
            </div>
          ...
          >
            <div className="container">
              ...
              >
                ...
                <div
                  className="schedule-roadmap"
                  aria-label="Planned event flow, details to be announced"
                >
                  <div>
                    <b>01</b>
                    <span>
                ...
                <small className="schedule-note">
                  A single-day symposium
                  flow. Official sequence
                  and timings will be shared
                  after confirmation.
                </small>
                ...
                {coordinators.map(
                  (
                    ...
                    <motion.article
                      ...
                      className={`coordinator-card coordinator-${
                        index === 0
                          ? 'hod'
                          : index < 3
                          ? 'faculty'
                ...
                <div className="modal-sections">
                  ...
                  {selectedEvent.themes && (
                    <div>
                      ...
                      <ul className="modal-inline-list">
                        {selectedEvent.themes.map(
                          (theme) => (
                            <li
                              key={
                                theme
                  ...
                  <div>
                    ...
                    <p className="modal-preformatted">
                      {
